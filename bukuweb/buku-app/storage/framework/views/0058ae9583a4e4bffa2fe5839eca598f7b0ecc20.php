                ...
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        <li class="card text-end list-group-item">
                            <a href="<?php echo e(route("create")); ?>" class="btn btn-outline-primary">Tambah Data Buku</a>
                        </li>
...
</html><?php /**PATH C:\Users\Devi\Documents\kedaireka\latihanGithub\project-kedaireka\exercise5\buku-app\resources\views/books/index.blade.php ENDPATH**/ ?>