              ...
              <div class="form-group">
                <label for="book_types">Genre</label>
                    <select class="custom-select d-block w-100 form-control" id="book_types" name="book_types_id">
                        ...
                        <option value="<?php echo e($bookType->id); ?>"> <?php echo e($bookType->genre); ?> </option>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Devi\Documents\kedaireka\latihanGithub\project-kedaireka\exercise5\buku-app\resources\views/books/create.blade.php ENDPATH**/ ?>